    ...
    var url = window.location.protocol +"//"+ window.location.hostname+ ":" +window.location.port + window.location.pathname;
     ...
     return {
        $ui: {"rows": [
            ...
            {"url": url+"backend/lumen/public/cancel",
            scheme:{
                $init:function(row){
            ...
            {
                rows:[
                    {id:"myform_remark","autoheight": true,"view": "form","borderless": true,
                        rows:[
                            {view:"label", label:"Alasan pembatalan pendaftaran kode baru (Cancel) :"},
                            {id:"remark", name:"remark", view:"textarea", readonly:true, height:100}
                        ]
                    }
                ]
            }
