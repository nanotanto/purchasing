...
class CatalogController extends Controller
{
    public function index(Request $request){
        $data = Catalog::where('status','=','ACTIVE')->with(['category','product','sub','uom','vendorReferensi','vendorKomparasi','uompurch'])->orderBy('activation_date', 'DESC');
    ...
    public function option(Request $request, $id){
        $data = Catalog::where('status','=','ACTIVE')->where('jenis_kode', '=', $id)->get(); 
    ...
    public function register(Request $request){
        $data = Catalog::where('status','NON ACTIVE')->with(['category','product','sub','uom'])->orderBy('request_date', 'DESC');  
        $filter = $request->input('filter', false);
        $sort = $request->input('sort', false);
    ...
    public function CatalogFilter(Request $request){
        ...
        $data = Catalog::where('status','=','ACTIVE')->whereBetween('activation_date', [$from, $to])->get();
