    ...
    var toolbar = {
        rows:[
            {view: "toolbar", padding:8, elements: [
                    ...
                    {view: "label", align: "right", label: "<div class='header'><span style='font-size:20px';'font-weight:bold'>PT Yamaha Motor Parts Manufaturing Indonesia </span><div class='detail'></div>"},
                    {view: "button",type: "icon",width: 80,css: "app_button",icon: "fas fa-user",label: " Logout",click: "location.href='"+url+"#!/logout'"}
                ]
            }
        ]
    };
        ...
        rows:[ 
            ...
            },
            {
                template:"<div  style='font-size:70%;'>\n\
                            Created By <a href=''>PT Yamaha Motor Parts Mfg Indonesia</a>\n\
                            &copy; 2019  Ver. : 1.0 \n\
                          </div>",
                height:20 
            }
