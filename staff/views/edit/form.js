define([], function() {
    ...
    return {
        ...
        "elements": [
            ...
            {"cols": [      
            {view: "uploader", name:"quotation", id:"upl1", autosend:true, value: 'Upload Quotation - pdf', link:"mylist1", accept:"application/pdf", upload:url+"../backend/lumen/public/uploadfile","height": 30,"width": 150},
            {view:"list",  id:"mylist1", type:"uploader",autoheight:true, borderless:true},
            ]},
            {"cols": [
            {view: "uploader",name:"msds", id:"upl2", autosend:true, value: 'Upload MSDS - pdf', link:"mylist2", accept:"application/pdf", upload:url+"../backend/lumen/public/uploadfile","height": 30,"width": 150},
            {view:"list",  id:"mylist2", type:"uploader",autoheight:true, borderless:true},
            ]},
            {"cols": [
            {view: "uploader",name:"foto", id:"upl3", autosend:true, value: 'Upload Foto Part - jpg',accept:"image/png, image/gif, image/jpeg, image/jpg", link:"mylist3", upload:url+"../backend/lumen/public/uploadfile","height": 30,"width": 150},
            {view:"list",  id:"mylist3", type:"uploader",autoheight:true, borderless:true},
            ]},
            {"cols": [
            {view: "uploader",name:"drawing", id:"upl4", autosend:true, value: 'Upload Drawing - pdf', link:"mylist4",  accept:"application/pdf",upload:url+"../backend/lumen/public/uploadfile","height": 30,"width": 150},
            {view:"list",  id:"mylist4", type:"uploader",autoheight:true, borderless:true},
            ]},

            {id:"option",name:"status","label": "Status","value": "","options": ["ACTIVE","DELETE"],"view": "radio","height": 0,"width": 0,"labelAlign": "center",
                click:function(){
